...
abstract class AppLocalizations {
  ...
  ///
  /// In es, this message translates to:
  /// **'{name, select, searchTitle1{Buscar por nombre o departamento} notFound{No se encontraron lugares} profileTitle1{Perfil} dob{Fecha de cumpleaños} save{guardar perfil}  other{}}'**
